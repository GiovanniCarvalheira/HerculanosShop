    ...
    <Fragment>
      <footer className="py-3 bg-tertiary-custom">
        <div className="row m-0">
          ...
          <div className="col-lg-4 col-md-4 col-12 d-flex justify-content-center d-md-block">
            <span className="text-gold-link"><a href="https://github.com/GiovanniCarvalheira">Giovanni Carvalheira - {year}</a>
            </span>
          </div>
          <div className="col-lg-3 col-md-4 col-12 d-flex justify-content-center mt-3 mt-md-0">
